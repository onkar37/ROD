...
void Counting_Numbar_of_Mathing_String(char str[80], char search[10], FILE *fp);
void Printing_Output_with_Line_Numbar(char str[80], char search[10], FILE *fp);
void Line_Printing_After_Matching(char str[80], char search[10], FILE *fp);
void Line_Printing_Befor_Matching(char str[80], char search[10], FILE *fp);
